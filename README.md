...
<p align="center">
  <a href="https://pkg.go.dev/github.com/sparklayer-io/mimetype">
    <img alt="Go Reference" src="https://pkg.go.dev/badge/github.com/sparklayer-io/mimetype.svg">
  </a>
  <a href="https://codecov.io/gh/sparklayer-io/mimetype">
    <img alt="Code coverage" src="https://codecov.io/gh/sparklayer-io/mimetype/graph/badge.svg">
  </a>
  <a href="https://goreportcard.com/report/github.com/sparklayer-io/mimetype">
    <img alt="Go report card" src="https://goreportcard.com/badge/github.com/sparklayer-io/mimetype">
  </a>
  <a href="LICENSE">
...
- possibility to [extend](https://pkg.go.dev/github.com/sparklayer-io/mimetype#example-package-Extend) with other file formats
- common file formats are prioritized
- [text vs. binary files differentiation](https://pkg.go.dev/github.com/sparklayer-io/mimetype#example-package-TextVsBinary)
- no external dependencies
- safe for concurrent usage

## Install
```bash
go get github.com/sparklayer-io/mimetype
```
...
```
See the [runnable Go Playground examples](https://pkg.go.dev/github.com/sparklayer-io/mimetype#pkg-overview).
...
[open an issue](https://github.com/sparklayer-io/mimetype/issues/new?assignees=&labels=&template=mismatched-mime-type-detected.md&title=).

## Tests
In addition to unit tests,
[mimetype_tests](https://github.com/sparklayer-io/mimetype_tests) compares the
...
[here](https://github.com/sparklayer-io/mimetype_tests/actions).

## Benchmarks
Benchmarks are performed when a PR is open. The results can be seen on the
[workflows page](https://github.com/sparklayer-io/mimetype/actions/workflows/benchmark.yml).
...
[reader](https://pkg.go.dev/github.com/sparklayer-io/mimetype#DetectReader)
or from a [file](https://pkg.go.dev/github.com/sparklayer-io/mimetype#DetectFile)
**mimetype** limits itself to reading only the header of the input.
<div align="center">
  <img alt="how project is structured" src="https://raw.githubusercontent.com/sparklayer-io/mimetype/master/testdata/gif.gif" width="88%">
</div>

## Contributing
Contributions are never expected but very much welcome.
[mimetype_tests](https://github.com/sparklayer-io/mimetype_tests/actions/workflows/test.yml)
